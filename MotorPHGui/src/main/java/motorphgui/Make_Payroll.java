...
public class Make_Payroll extends javax.swing.JDialog {

    /**
     * Creates new form Employee_Details
     */
    public Make_Payroll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        combobox_cutoffperiod.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
    ...
    private void btn_GenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_GenerateActionPerformed
        ...
        Employee_PayrollResult resultDialog = new Employee_PayrollResult(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Make_Payroll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            Make_Payroll dialog = new Make_Payroll(new javax.swing.JFrame(), true);
